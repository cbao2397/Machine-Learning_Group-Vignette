...
> Now you will try Supervised Machine Learning on your own using the Breast Cancer Wisconsin (Diagnostic).
...
> Now you will test the model and have it make predictions based on the dataset. 
...
> Let's check the accuracy of the machine's predictions. 
...
> Confirming Dichotomous Outcomes
