...
Use simple random sampling to split the data
...
Let's use the data set to predict malignant or benign cancer based on texture1 (standard deviation of gray scale values). Fit the model...
...
kmodel <- train(Diagnosis~., data = b, method = 'glm', trControl = train.control, family = "binomial")
print(kmodel)
```
